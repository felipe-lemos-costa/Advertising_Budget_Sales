...
# Conclusion
This analysis clearly demonstrates that advertising investments in TV and Radio have a significant positive impact on sales, with TV advertising being the most influential channel. Newspaper advertising showed minimal contribution and was rightly excluded from the final model to improve prediction accuracy. The Decision Tree model, after hyperparameter optimization, provided a robust and reliable tool to predict sales based on advertising budgets, achieving high accuracy and low error rates. These insights can guide marketing budget allocation decisions to maximize sales effectiveness, prioritizing TV and Radio channels for optimal return on investment.
